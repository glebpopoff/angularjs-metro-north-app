var angularJSMetroNorthDirectives = angular.module('angularJSMetroNorthDirectives', ['ngResource']);

/*
* Directive to format date & time directive
* Usage: <span metro-north-date-formatter="JS-DATE-OBJECT"></span>
*/
angularJSMetroNorthDirectives.directive('metroNorthDateFormatter', function () {
